# Decorators de Validação Customizados - weliv

## 📋 Visão Geral

Este módulo contém decorators customizados para validação de dados específicos do sistema weliv, seguindo padrões brasileiros e regras de negócio específicas.
...
Todas as mensagens estão em português brasileiro e são específicas para o contexto do weliv:
