# Sistema de Mensagens Centralizadas - TemplateLobocode

## 📋 Visão Geral

Este módulo centraliza todas as mensagens do sistema TemplateLobocode, incluindo validações, erros, sucessos, logs e notificações. O sistema oferece consistência, manutenibilidade e suporte a interpolação de variáveis.
...
```typescript
NOTIFICATION_MESSAGES.USER.WELCOME          // "Bem-vindo ao TemplateLobocode!"
